                    ...
                    <div className="col-sm-6">
                        <div className="card text-white bg-dark mb-3 card text-center" style={{width: "32rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="/Computers_Electronics" target= "_blank" className="btn btn-outline-light"><i>Computers & Electronics</i></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="card text-white bg-warning mb-3 card text-center" style={{width: "20rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="/Books_Movies" target= "_blank" className="btn btn-outline-light"><i>Books & Movies</i></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="card text-white bg-success mb-3 card text-center" style={{width: "20rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="/Cosmetics_PersonalCare" target= "_blank" className="btn btn-outline-light"><i>Cosmetics & Personal Care</i></Link>
                            </div>
                        </div>
                    </div>
                </div>
